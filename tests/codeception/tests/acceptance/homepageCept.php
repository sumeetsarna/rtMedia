...
// Need to decalre what page are we on
// am on root index.php
$I->amOnPage('/');
...
$I->seeCurrentUrlEquals('/sumeet/product/apple/') ;
...
$I->seeCurrentUrlEquals('/sumeet/cart/') ;
$I->click('Proceed to Checkout');
//$I->seeInCurrentUrl('')
$I->seeCurrentUrlEquals('/sumeet/checkout/') ;
